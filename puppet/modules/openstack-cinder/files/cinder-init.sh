...
keystone endpoint-create --region ifsc-sj --service-id=$(keystone service-list | awk '/ volume / {print $2}')  --publicurl=http://cinder-controller.openstack.sj.ifsc.edu.br:8776/v1/%\(tenant_id\)s  --internalurl=http://cinder-controller.openstack.sj.ifsc.edu.br:8776/v1/%\(tenant_id\)s  --adminurl=http://cinder-controller.openstack.sj.ifsc.edu.br:8776/v1/%\(tenant_id\)s
